  ...
  return <footer className="bg-slate-700 text-slate-200 text-sm mt-16">
    <Container>
      <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
        ...
        <p className="mb-2">This is an online store for selling variety of electronics and phone accesories and we are offering servicing service to our clients and customers. All our products has warranty of 18 months.</p>
